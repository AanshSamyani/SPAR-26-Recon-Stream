#!/bin/bash
# Sequentially evaluate all 16 arms (arm_0 to arm_15) for exp_6/XY.
...
#   nohup bash run_exp6_XY_all_arms_eval.sh > /workspace/spar-team-recon/projects/ip/results/exp_6/XY/eval_nohup.out 2>&1 &
