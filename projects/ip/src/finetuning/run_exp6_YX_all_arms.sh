#!/bin/bash
# Sequentially finetune all 16 arms (arm_0 to arm_15) for exp_6/YX.
...
#   nohup bash run_exp6_YX_all_arms.sh > /workspace/spar-team-recon/projects/ip/results/exp_6/YX/nohup.out 2>&1 &
